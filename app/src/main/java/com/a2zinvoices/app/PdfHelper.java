...
public final class PdfHelper {
 ...
 public static File create(Context c,Invoice inv,CompanyInfo co)throws IOException{
  ...
  int y=M+12; title.setTextAlign(Paint.Align.RIGHT); normal.setTextAlign(Paint.Align.RIGHT);
  ...
  title.setTextAlign(Paint.Align.LEFT);bold.setTextAlign(Paint.Align.LEFT);normal.setTextAlign(Paint.Align.LEFT);x.drawText("فاتورة",M+120,M+18,title);x.drawText("رقم الفاتورة: "+inv.number,M+120,M+38,bold);x.drawText("التاريخ: "+inv.date,M+120,M+54,normal);
  y=Math.max(y,M+72);x.drawLine(M,y,W-M,y,normal);y+=22;
  bold.setTextAlign(Paint.Align.RIGHT);normal.setTextAlign(Paint.Align.RIGHT);x.drawText("المطلوب من: "+inv.customerName,W-M,y,bold);y+=15;
  ...
  y+=12; normal.setTextAlign(Paint.Align.RIGHT); bold.setTextAlign(Paint.Align.RIGHT);
